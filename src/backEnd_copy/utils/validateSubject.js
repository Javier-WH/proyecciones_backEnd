...
const asignationsSchema = Joi.object({
  q1: Joi.string().uuid().allow(null),
  q2: Joi.string().uuid().allow(null),
  q3: Joi.string().uuid().allow(null),
});

const subjectSchema = Joi.object({
  innerId: Joi.string().uuid(),
